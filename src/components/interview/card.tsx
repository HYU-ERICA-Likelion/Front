...
export default function InterviewCard({ name, position, img, text }: Props) {
  return (
    <div className="flex flex-col bg-[#474343] w-[325px] max-h-[412px] p-[22px_15px_15px_15px] text-center rounded-[14px] items-center">
      ...
      <div className="flex flex-row items-center gap-x-[12px] p-[18.5px_13.5px] bg-[#292725] rounded-[12px]">
