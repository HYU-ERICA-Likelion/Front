...
export default function PartInput({
  ...
  return (
    <div className="flex gap-[79px] items-center w-[863px] h-[188px]">
      <p className="w-[91px] text-[20px] font-[600] leading-[140%] tracking-[-0.1px] text-[#FFFFFF]">
        구하는 파트
      </p>
      <div className="w-[294px] flex flex-col gap-[13px]">
        {/* 기획&디자인 */}
        <div className="w-[239px] h-[54px] flex gap-[54px] items-center">
          <label
        ...
        {/* 프론트 */}
        <div className="w-[239px] h-[54px] flex gap-[66px] items-center">
          <label
            htmlFor="frontAppNum"
            className="text-[20px] font-[600] leading-[140%] tracking-[-0.1px] text-[#FFFFFF]"
          >
        ...
        {/* 백 */}
        <div className="w-[239px] h-[54px] flex gap-[101px] items-center">
          <label
            htmlFor="backAppNum"
            className="text-[20px] font-[600] leading-[140%] tracking-[-0.1px] text-[#FFFFFF]"
          >
